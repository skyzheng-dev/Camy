import { View, Text, TouchableOpacity, ScrollView, FlatList, FlatListComponent, Modal, Touchable, TouchableWithoutFeedback, Keyboard, KeyboardAvoidingView, Platform, TextInput } from 'react-native'
