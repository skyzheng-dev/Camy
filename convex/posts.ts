...
export const createPost = mutation({
    ...
    //Handler = "What should happen when X occurs"
    //Async = "This might take a while, so don't freeze everything else"
...
export const getFeedPosts = query({
  handler: async(ctx) => {
    ...
    //enchance posts with user data and interaction status
